...
import test.actioninterface.ActionInterface;
...
public class Action extends BaseClass implements ActionInterface {
	...
	public boolean switchToFrameByIndex(WebDriver driver,int index) {
		boolean flag = false;
//		try {
//			WebElement w=new WebDriverWait(driver, 15).until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//iframe")));
